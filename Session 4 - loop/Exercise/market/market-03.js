...
while (true) {
  ...
  var qtyApple = parseInt(
    prompt(`Masukkan jumlah Apel, Stock : ${stockApple}`)
  );
...
while (true) {
  ...
  var qtyGrape = parseInt(
    prompt(`Masukkan jumlah Anggur, Stock : ${stockGrape}`)
  );
...
do {
  ...
  var qtyOrange = parseInt(
    prompt(`Masukkan jumlah Jeruk, Stock : ${stockOrange}`)
  );
